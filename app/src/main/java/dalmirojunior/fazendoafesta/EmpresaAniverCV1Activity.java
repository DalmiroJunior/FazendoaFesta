...
public class EmpresaAniverCV1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_empresa_aniver_cv1);
        ...
        buttonIr.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(EmpresaAniverCV1Activity.this, OrcamentoActivity.class));
            }
        });
        ...
        buttonLoc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick (View v){
                Intent it  = new Intent(EmpresaAniverCV1Activity.this, MapsActivity.class);
