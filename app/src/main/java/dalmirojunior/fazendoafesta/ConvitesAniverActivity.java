...
public class ConvitesAniverActivity extends AppCompatActivity {
    ...
    private String[] empresasC = {"Empresa 1","Empresa 2","Empresa 3","Empresa 4","Empresa 5"};
        ...
        ListEmpresasConvites.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (position == 0){
                    ...
                    startActivity(new Intent(ConvitesAniverActivity.this, ConstrucaoActivity.class));
                }else if(position == 2){
                    startActivity(new Intent(ConvitesAniverActivity.this, ConstrucaoActivity.class));
                }else if(position == 3){
                    startActivity(new Intent(ConvitesAniverActivity.this, ConstrucaoActivity.class));
